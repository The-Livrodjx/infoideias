                ...
                <table id="lista-noticia" class="table dataTable table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="titulo"> <?= ucwords($noticia->titulo) ?></td>
                            <?php if ($noticia->texto === '') { ?>
                                <td class="text-center">Não possui texto</td>
                            <?php } ?>
                            <td class="text-center"><?= ucwords($noticia->texto) ?></td>
                            <td>
                                <a href='/teste01/noticias/editar/<?= $noticia->id ?>'><span
                                        class="glyphicon glyphicon-pencil"></span></a>
                                <a href="/teste01/noticias/excluir/<?= $noticia->id ?>"><span
